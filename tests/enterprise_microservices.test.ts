...
import { Controller, Get } from "../src/mvc/Controller";
...
import { MessageBroker, createBroker } from "../src/microservices/Broker";
  ...
  describe("Dependency Injection", () => {
    ...
    test("Container resolves nested dependencies", () => {
      ...
      class DataService {
        ...
        getData() {
          return `${this.config.getPrefix()}_DATA`;
        }
      }
